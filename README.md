...
client = NLPCloud::Client.new("bart-large-cnn","4eC39HqLyjWDarjtT1zdp7dc", true, "fr")
...
1. (Optional) `remove_end_sequence`: Whether you want to remove the end sequence form the result, as a boolean. Defaults to false.
